...
/// @Author: gstory
/// @CreateDate: 2022/8/12 16:37
/// @Email gstory0404@gmail.com
/// @Description: 开屏广告

class GromoreSplashAd extends StatefulWidget {
  ...
  /// [height] 高
  ///
  /// [callBack] 广告回调，具体查看[GromoreSplashCallBack]
  ///
  GromoreSplashAd({Key? key, required this.androidId, required this.iosId, required this.width, required this.height, this.callBack}) : super(key: key);

  @override
  State<GromoreSplashAd> createState() => _GromoreSplashAdState();
}

class _GromoreSplashAdState extends State<GromoreSplashAd> {
  final String _viewType = "com.gstory.gromore/SplashView";
